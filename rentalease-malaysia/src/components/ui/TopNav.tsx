        ...
        <div className="flex items-center justify-between h-16">
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  isActive(link.href)
                    ...
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100' // default
                }`}
              >
                {link.label}
              </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="text-right">
              ...
              {/* Role badge — helps the user always know which account type they're in */}
          ...
          >
            {/* Three lines = menu icon; X = close icon */}
            {menuOpen ? (
              <svg
